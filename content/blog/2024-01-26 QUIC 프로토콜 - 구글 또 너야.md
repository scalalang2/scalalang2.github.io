...
![](/img/medium/1-NeORnQXlynMR82pInGtOLA-4a497c5472e1.png "[HPBN | TLS Handshake](https://hpbn.co/transport-layer-security-tls/#tls-handshake)")
...
![](/img/medium/1-TROKtb8NjImE0d8WK8lbvw-ab9fe78e3049.png "HPBN | 대역폭이 증가하는 경우 / RTT가 감소하는 경우의 페이지 로드 시간 차이")
...
![](/img/medium/1-21oT1D59hHxGdZnK1eYnUg-23910570c1bb.png "Ref. [QUIC is not Quick Enough over Fast Internet](https://web.eecs.umich.edu/~xumiao/docs/imc23-quic-poster.pdf) | ACM IMC’23")
...
![](/img/medium/1-IVtf1cncYE7E2WjdVaqQJw-27e0dd9fcf86.png "[Cloudflare | Examining HTTP/3 usage one year on](https://blog.cloudflare.com/http3-usage-one-year-on)")
...
![](/img/medium/1-baEy53lOgmk2cEEkrmEfmA-58da2b407579.png "구글 프론트-엔드 서버에서 암호화 통신이 차지하는 비중")
...
![](/img/medium/1-a6Lj752PpRGDidkr-L30Ww-d6b68565577d.png "[HPBN | TCP Head-of-line blocking](https://hpbn.co/building-blocks-of-tcp/#head-of-line-blocking)")
...
![](/img/medium/1-wB4phLmQmvWATLh57Ffewg-3053fab1474f.png "QUIC의 커넥션 생성과정")
...
![](/img/medium/1-sCOkV0uU6JXmBBsjjMUN_Q-bf62f8a03bfa.png "[Ref. Certificate Based Authentication Mechanism for PMU Communication Networks Based on IEC](https://www.mdpi.com/2079-9292/7/12/370)")
...
![](/img/medium/1-J7BatK9MqKnDJQHzmp8QTQ-242decc731d0.png "QUIC 패킷 기본 구조")
...
![](/img/medium/1-s03PSlD_XBhhfBUjB3Ykdw-f3f2ce671363.png "[HPBN / Streams, Messages, and Frames](https://hpbn.co/http2/)")
...
![](/img/medium/1-m02nSLMIUhMtwf-0ywVVYw-969e00f32a29.png "[TCP Congestion Control: A Systems Approach](https://tcpcc.systemsapproach.org/algorithm.html)")
...
![](/img/medium/1-jZEV_mcCbSdtupnGnB7gZA-3687957c9b7b.png "Credit-based Flow Control의 예시 by scalalang2 (직접 그렸다 ㅎㅎ..)")
...
![](/img/medium/1-48iMerb-vZ-GmyyFjrEFkA-5a82d89c81eb.png "3번의 회귀 테스트를 진행하면서, 검색 레이턴시를 측정한 결과")
...
![](/img/medium/1-cESrm_WaRM2JTmYFGb1i2w-260222ca86fb.png "Handshake Latency 비교")
...
![](/img/medium/1-KMcywtwSCjzgVHEt9KW3rA-64e2a6975624.png "구글에서 집계한 모든 커넥션의 평균 RTT를 조사한 결과")
...
![](/img/medium/1-DDQ1JY03MHhQurNyaROEbQ-73195ddf3e20.png "TCP/TLS대비 QUIC을 도입했을 때의 효과")
...
![](/img/medium/1-qR9OLIyw6IiW1nhwVWIYuQ-5f1836d1ce87.png "검색 결과 레이턴시")
...
![](/img/medium/1-qfuo3dOhnNzsITEvLRBvkA-349ed30184dc.png "Mean Video Latecny")
...
![](/img/medium/1-TVjHXG8BkNFsIIEHz16KMw-5f8476af15de.png "Rebuffer Ratio Reduction by percentile")
...
![](/img/medium/1-a4r1xGmOk218K87vExj7qw-440f9ee54678.png "TCP/IP에서 재전송되는 비율")
...
![](/img/medium/1-F5s0x6TOT8EmB8VBiOF9KA-1941ac5e9145.png "1200부터 5byte 간격으로 늘리면서 도달율을 조사한 그래프")
...
![](/img/medium/1-j4M9wL9kC1_jpjV64CAmXg-51766e0c0b1a.png "1년동안 배포된 QUIC 프로토콜 버전")

...
![](/img/medium/1-KEL5FPiL7_ANvDChSwnnYQ-cac84afd2b81.png "유튜브에 서비스의 1분/1초 기준 CPU 사용량을의 히트맵 분포를 보여준다.")
...
![](/img/medium/1-wKzpUjyYtkHLBhUsxU9b_Q-9f9b3a79426d.png "시끄러운 이웃과 시끄럽지 않은 이웃이 공존한 상황에서 CPU 할당량 이상을 요청한 경우")
...
![](/img/medium/1-EQQjgslKtSPzQI48A8htJQ-3de6ce58320f.png "마이크로 서비스 아키텍처에서 서비스 호출 관계를 표현")
...
![](/img/medium/1--uwd7BEHQPp-QBxXxmaiUQ-cbe92f1b233b.png "Parallel calls 에서 꼬리 지연의 영향을 보여주는 시뮤레이션")
...
![](/img/medium/1-pJLwVahvdsWV3FAQRjIvaA-958bb0a4e469.png "메모리, CPU, RIF(requests-in-flight)를 보여주는 그래프 (1초 단위로 샘플링한 데이터이다)")
...
![](/img/medium/1-pHZtjA-Zlv-W8FZXxY_0FQ-9d1c68b60a1b.png "Normalized YouTube Homepage server request error rate and latency p99.9 (red), p99 (green), and p50 (blue)")
...
![](/img/medium/1-InLWwLGJ3bYC2Tidn9wVSw-538d323ab3e0.png "프리퀄은 클라이언트 및 전용 로드 밸런서에 적용될 수 있다.")


![](/img/medium/1-IyC_zdxIb6LC4xxrECE5Mw-62d7b5ca7408.png "Prequal 구조도")
...
![](/img/medium/1-xfHkgpYPw2wnukGTnwzsQQ-4c882f6f2b87.png "RIF와 예상 레이턴시를 계산하는 방법")
...
![](/img/medium/1-WAZJp_m0Z5gwq9VBlQooig-0c540c7f0352.png "CPU 부하 증가에 따른")
...
![](/img/medium/1-kKGyE7cagcWNMhR_HCijUQ-be40bdaa655e.png "서버 선택 규칙에 따른 레이턴시 성능 평가")

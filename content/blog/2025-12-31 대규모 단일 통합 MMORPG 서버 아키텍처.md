...
![](/img/medium/1-0-OSQQD0H_UGDGZQlwPDVw-c45b6f4ddb67.png "사진 출처 : [동아 사이언스](https://m.dongascience.com/ko/news/44830)")
...
![](/img/medium/1-Ajj9bUemoWqiGzdqqKiLvA-e37fdb848aae.png "단순하고 자주 쓰이는 형태의 게임 서버 구조")
...
![](/img/medium/1-GBME5A28Zi5nyNp2cs1XvA-24a450037fde.png "마비노기 모바일과 아이온2의 서버 선택 화면")
...
![](/img/medium/1-rSpAgM5kX3fGvKiiN9Z3Ng-f3ef3057d914.png "[한국인이 좋아하는 50가지 문화편](https://www.gallup.co.kr/gallupdb/reportContent.asp?seqNo=1481)")
...
![](/img/medium/1-UKPv7j3HQCBs1mCzG3rtAQ-e4e9334785a6.png "가장 이상적인 형태의 서버 아키테처")
...
![](/img/medium/1-ID0EOwHBkRI_XAcnz-ceng-6246ffe8b3d8.png "네트워크 I/O를 전담하는 게이트웨이 서버")
...
![](/img/medium/1-UAyo-EsxXAQwEnuYB5iq2A-01ff64ba8a85.png "대표 MMORPG 게임 메이플스토리의 채널링")
...
![](/img/medium/1-zitPGZxrOa0fCIVZ3tKfVQ-ef944a70aafa.png "월드 오브 워 크래프트의 한 장면")
...
![](/img/medium/1-E4OSjURJPS-0RwHz75XXLA-93fe09a36915.png "[3대의 Silo로 구성된 Orleans Cluster](https://learn.microsoft.com/en-us/dotnet/orleans/overview)")
...
![](/img/medium/1-QK1D3qTahc1IRxiwz8sjjQ-d4340bb732e2.png "상어가 해저 케이블을 물어뜯는 모습 : 출처 — [유튜브](https://www.youtube.com/watch?v=1ex7uTQf4bQ)")
...
![](/img/medium/1-sftVGeQ-1rCw_bDplA1KWg-b0d6a836c3dd.png "거래 중 통신 오류로 인해 데이터 무결성이 깨진 상황")
...
![](/img/medium/1-j6IWXCh-TwBcygQRXzCmug-5f32feba4dc5.png "트랜잭션이 취소되는 과정을 보여준다")


![](/img/medium/1-Usr4SITRffuDrlwbxoBn2Q-20583b826bc1.png "게임 로직 서버는 분산 액터 모델인 Orleans 클러스터로 구성한다")
...
![](/img/medium/1-rr2I3cBHDDS7i_7U9ZV5yA-1ca9803a67b0.png "임피던스 불일치의 예시")
...
![](/img/medium/0-ZsIniThML23nAqB4-71662eaf5c1e.png "본인의 비틱 디스크")
...
![](/img/medium/1-HtQM7k3xk852UVQdl2Wikw-87f172020fe9.png "Primary/Secondary 복제 모델")
...
![](/img/medium/1-hmILXImq4ksu-IiEVAZRxA-e6009c0c99f1.png "게임서버에서 Actor의 상태를 직렬화 해서 DynamoDB에 저장한다.")
...
![](/img/medium/1-UPOXV5FSOO_0aPGLlh5mwg-6081a72e7dd2.png "Many-To-Many 관계를 다루는 경우가 빈번한 경우")
...
![](/img/medium/1-ILQ8vXiqig3gvTabmI0-hw-5f9fde8bcfbe.png "심리스 오픈 월드 구현 예시")
...
![](/img/medium/1--Md_Ie1eo1VLY8hacVH7-g-ae1f571965c7.png "게이트웨이 서버와 게임 서버 사이의 NATS 레이어가 추가됨")
